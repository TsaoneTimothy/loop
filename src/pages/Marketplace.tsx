  ...
  return (
    <div className="pb-20">
      ...
      <div className="px-6 py-3 flex gap-3">
        <div className="loop-search flex-1">
        ...
        <div className="grid grid-cols-2 gap-4">
          {featuredItems.slice(0, 4).map((item) => (
            <div key={item.id} className="loop-card overflow-hidden">
              <div className="h-36 overflow-hidden rounded-lg mb-2">
                <img 
                  src={item.image} 
                  alt={item.title} 
      ...
      <section className="mt-6 px-6 overflow-x-auto">
      ...
      <Link 
        to="/create-listing" 
        className="fixed bottom-20 right-6 bg-primary text-white p-4 rounded-full shadow-lg"
      >
